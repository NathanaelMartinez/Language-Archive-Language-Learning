    ...
    return Center(
        child: ListView(
          children:[
            ListTile( 
              title: Container( 
                padding: EdgeInsets.only(top: determineTopMargin(display), bottom: determineBottomMargin(display)),
                child: Column(
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        if (emailInput.text.isEmpty ||
                            passwordInput.text.isEmpty || nameInput.text.isEmpty || confirmInput.text.isEmpty) {
                        ...
                        } else if (confirmInput.text != passwordInput.text) {
